<div>
          ...
          <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            ...
            <div class="page-title-right">
              <ol class="breadcrumb m-0">
                <a href="{{route('bahanbaku.create')}}" type="button" class="btn btn-success "><i class="mdi mdi-plus me-1"></i> Add Data </a>
              </ol>
            </div>
          </div>
        </div>
                    ...
                    <tr>
                      ...
                      <td>
                        <div class="d-flex gap-3">
                          <button wire:click="DetailData('{{$bb->kode_bahan_baku}}')" class="btn btn-warning waves-effect" data-bs-toggle="modal" data-bs-target="#updateModal">Edit
                          </button>
                          ...
                          <button class="btn btn-danger waves-effect waves-light" data-bs-toggle="modal" data-bs-target="#delete">
                            Delete
                          </button>
  ...
  {{-- MODAL EDIT --}}
  <div wire:ignore.self id="updateModal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
