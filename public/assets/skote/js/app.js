    ...
    document.getElementById("header-lang-img") &&
      ("en" == e
        ? (document.getElementById("header-lang-img").src =
          "assets/skote/images/flags/us.jpg")
        : "sp" == e
          ? (document.getElementById("header-lang-img").src =
            "assets/skote/images/flags/spain.jpg")
          : "gr" == e
            ? (document.getElementById("header-lang-img").src =
              "assets/skote/images/flags/germany.jpg")
            : "it" == e
              ? (document.getElementById("header-lang-img").src =
                "assets/skote/images/flags/italy.jpg")
              : "ru" == e &&
              (document.getElementById("header-lang-img").src =
                "assets/skote/images/flags/russia.jpg"),
        localStorage.setItem("language", e),
        null == (t = localStorage.getItem("language")) && a(n),
        s.getJSON("assets/skote/lang/" + t + ".json", function (e) {
          s("html").attr("lang", t),
    ...
    1 == s("#light-mode-switch").prop("checked") &&
      ...
      ? (s("html").removeAttr("dir"),
        ...
        s("#bootstrap-style").attr(
          "href",
          "assets/skote/css/bootstrap.min.css"
        ),
        s("#app-style").attr("href", "assets/skote/css/app.min.css"),
      ...
      : 1 == s("#dark-mode-switch").prop("checked") &&
        ...
        ? (s("html").removeAttr("dir"),
          ...
          s("#bootstrap-style").attr(
            "href",
            "assets/skote/css/bootstrap-dark.min.css"
          ),
          s("#app-style").attr("href", "assets/skote/css/app-dark.min.css"),
        ...
        : 1 == s("#rtl-mode-switch").prop("checked") &&
          ...
          ? (s("#light-mode-switch").prop("checked", !1),
            ...
            s("#bootstrap-style").attr(
              "href",
              "assets/skote/css/bootstrap-rtl.min.css"
            ),
            s("#app-style").attr("href", "assets/skote/css/app-rtl.min.css"),
            s("html").attr("dir", "rtl"),
          ...
          (s("#light-mode-switch").prop("checked", !1),
            ...
            s("#bootstrap-style").attr(
              "href",
              "assets/skote/css/bootstrap-dark-rtl.min.css"
            ),
            s("#app-style").attr("href", "assets/skote/css/app-dark-rtl.min.css"),
            s("html").attr("dir", "rtl"),
